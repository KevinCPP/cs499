...
class UI_Element_Factory:
    ...
    def make_checkbox_element(self, label, tooltip=None, checked=False, callback=None) -> QHBoxLayout:
        ...
        # Set the checkbox's initial checked state
        checkbox.setChecked(checked)

        # Connect the checkbox's stateChanged signal to the callback function if provided
        if callback:
            checkbox.stateChanged.connect(callback)

        # Store the widget for later retrieval
        self.widget_values[label] = checkbox
